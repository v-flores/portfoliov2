const portfolioItems = [
    {
        title: 'Obscure Events',
        sinopsis: 'Design & Developed',
        desc: 'I created this website with HTML5, CSS, and vanilla Javascript for my event marketing company Obscure Events.',
        img: './portfolio/obscure.jpg',
        live: 'https://www.obscureevents.com/',
        repo: 'https://github.com/v-flores/obscure_web',
        idx: 1
    },
    // {
